const ProductCard = ({ img_url, price, name, desc }) => {
  return (
    <>
      <div className="flex flex-col items-center justify-center bg-white w-80 rounded-xl shadow-md m-4">
        <div className="flex flex-inline w-full items-center justify-center p-4 pb-0">
          <img
            src={img_url}
            alt="Product Image"
        ...
        <div className="flex flex-col flex-grow justify-center items-center p-4 w-full">
        ...
        <div className="flex items-center justify-center p-4">
          <div className=" w-full ">
            <p className=" rounded-xl text-center bg-slate-600 px-6 py-2 text-white font-semibold">
              {price}
            </p>
          </div>
        </div>
