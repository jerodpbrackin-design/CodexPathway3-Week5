const ProductCard = ({ img_url, price, title, desc }) => {
  return (
    <div className="w-full h-full flex flex-col bg-gray-100 items-center justify-center p-4">
      <div className="mt-2 w-[40%] bg-white rounded-xl shadow-md">
        <div>
          <img
            src={img_url}
            alt="Product Image"
            className="mb-9 bg-slate-800 w-full object-cover rounded-t-xl rounded-xl shadow-md"
          />
        </div>
